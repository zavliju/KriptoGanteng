...
class ZSDES {
	...
	public static void main(String args[]) {
		...
		System.out.println("Enter the key as a 8 character hexadecimal value:");
	...
	private static int[] KS(int round, int[] key) {
		int C1[] = new int[28];
		int D1[] = new int[28];
		int CLeft[] = new int[14];
		int CRight[] = new int[14];
		int DLeft[] = new int[14];
		int DRight[] = new int[14];

		System.arraycopy(C1, 0, CLeft, 0, 14);
		System.arraycopy(C1, 14, CRight, 0, 14);
		System.arraycopy(D1, 0, DLeft, 0, 14);
		System.arraycopy(D1, 14, DRight, 0, 14);

		int temp0[] = xor(CLeft, DRight);
		int temp1[] = xor(CRight, DLeft);

		System.arraycopy(temp0, 0, C1, 0, 14);
		System.arraycopy(temp0, 0, C1, 14, 14);
		System.arraycopy(temp1, 0, D1, 0, 14);
		System.arraycopy(temp1, 0, D1, 14, 14);
